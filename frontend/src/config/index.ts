...
/**
 * Lit Protocol encryption configuration for exclusive content
 * Generated by: pnpm encrypt in lit-protocol directory
 *
 * This encrypted content can only be decrypted by users who meet the access control conditions.
 * Currently set to allow any user for testing (value: "0").
 * In production, update the conditions to check Sui wallet balance or NFT ownership.
 */
export const litProtocolConfig = {
  // Sample encrypted content: "This is exclusive content for TEAM KENTA members! 🥊"
  encryptedContent: "ojtr27BIoLkpgLrSeBUjzZo/JWmLxhehiUTHRdnZPlhapuv3oLpwKRB/+IzD9kSz6J0FtlFy9Rr2412rhStBY7vVirgXs39s6M0o4HntDI83ggjjy/LUGL4CYg6Lzbfqc6Z2AUWmWhoGORyPWu3UOngR9dwoZ31UTfAx5j91SDLi16xdRiMJZQI=",
  dataToEncryptHash: "f983cd43eb60a1422ba22f4c486bfaaf6eb9c0eea90970b05857802789854f3c",
